...
public class DatastoreServiceTest {
  ...
  public void testSearchLabels() {
    final Plugins plugins = datastoreService.search(null, null, Arrays.asList("scm"), Collections.emptyList(), null, 50, 1);
  ...
  public void testSearchAuthors() {
    final Plugins plugins = datastoreService.search(null, null, Collections.emptyList(), Arrays.asList("Kohsuke Kawaguchi"), null, 50, 1);
  ...
  public void testSearchRequiredCore() {
    final Plugins plugins = datastoreService.search(null , null, Collections.emptyList(), Collections.emptyList(), "1.505", 50, 1);
